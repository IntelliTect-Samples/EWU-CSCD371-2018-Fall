...
namespace tests
{
    ...
    {        
        ...
        {
            Course = new Assignment4.Course("Computer Science", ".net", 208, 21, 2, 4);
        ...
        {
            Assignment4.Course t = new Assignment4.Course("cs", "c and unix", 204, 2, 3, 4);
            Assignment4.Course t2 = new Assignment4.Course("cs", "c and unix", 204, 2, 3, 4);
